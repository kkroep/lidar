...
/* Summary
   ...
   waveform table. 
 */
struct CyU3PGpifWaveData CyFxGpifWavedata[]  = {
...
uint32_t CyFxGpifRegValue[]  = {
    0x800003B0,  /*  CY_U3P_PIB_GPIF_CONFIG (0x80000380 for external clock input) */
    0x000010AC,  /*  CY_U3P_PIB_GPIF_BUS_CONFIG (0x000010A7 for 16bit interface) */
 ...
 */
const struct CyU3PGpifConfig_t CyFxGpifConfig  = {
